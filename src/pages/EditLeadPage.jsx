...
export default function EditLeadPage({ leadData, onBack, onSave }) {
  ...
  // Pre-populate form with lead data on mount
  useEffect(() => {
    if (leadData) {
      setFormData({
        product: leadData.product || 'Home Loan',
        purpose: leadData.purpose || '',
        mobile: leadData.phone || '',
        requiredLoanAmount: leadData.amount || '',
        requiredTenure: leadData.tenure || '',
        leadSource: leadData.leadSource || 'Website',
        
        panNo: leadData.panNo || '',
        aadharNo: leadData.aadharNo || '',
        ...
        currentResidenceType: leadData.currentResidenceType || 'Owned',
        ...
        occupation: leadData.occupation || 'Salaried',
        companyType: leadData.companyType || '',
        companyName: leadData.companyName || '',
        loanEMI: leadData.loanEMI || '',
        
        periodOfEmployment: leadData.periodOfEmployment || '',
        retirementAge: leadData.retirementAge || '60',
        modeOfSalary: leadData.modeOfSalary || 'Bank Transfer',
        averageGrossSalary: leadData.averageGrossSalary || '',
        netMonthlyIncome: leadData.netMonthlyIncome || '',
        anyOtherMonthlyIncome: leadData.anyOtherMonthlyIncome || '',
        
        businessSince: leadData.businessSince || '',
        industry: leadData.industry || '',
        gstNo: leadData.gstNo || '',
        officeType: leadData.officeType || '',
        itrFiled: leadData.itrFiled || '',
        annualTurnover: leadData.annualTurnover || '',
        netProfit: leadData.netProfit || '',
        
        officeAddressLine1: leadData.officeAddressLine1 || '',
        officeAddressLine2: leadData.officeAddressLine2 || '',
        officeCity: leadData.officeCity || '',
        officeState: leadData.officeState || '',
  ...
  const handleSubmit = (e) => {
    ...
    const updatedLead = {
      ...
      status: leadData.status || 'Lead Generated',
    ...
    <div className={styles.page}>
      ...
      <div className={styles.header}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          ...
          <div>
            <h3 className={styles.headerTitle}>Edit Lead</h3>
